...
```ts
import { useCreateNewEvent, useGetMyEvents, useInviteUserToEvent, useGetPublicEvents } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateNewEvent(createNewEventVars);

const { data, isPending, isSuccess, isError, error } = useGetMyEvents();

const { data, isPending, isSuccess, isError, error } = useInviteUserToEvent(inviteUserToEventVars);

const { data, isPending, isSuccess, isError, error } = useGetPublicEvents();
...
```js
import { createNewEvent, getMyEvents, inviteUserToEvent, getPublicEvents } from '@dataconnect/generated';
